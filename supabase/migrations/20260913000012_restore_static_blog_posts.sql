INSERT INTO public.blog_posts (
  title, slug, excerpt, content, category, story_date, read_time_minutes, image, published, is_main, publish_date
)
VALUES
(
  ...
  'Resources', 'Innovation in practice', 4,
  '/img/blog/From 3-4th April, Binary Hub showed up and stood tall at the Global AI Summit on Africa. an even.jpg', true, false, '2025-11-02T12:00:00Z'
),
(
  ...
  'Community', 'The Binary Hub community', 5,
  '/img/blog/From 3-4th April, Binary Hub showed up and stood tall at the Global AI Summit on Africa. an even (1).jpg', true, false, '2025-11-09T12:00:00Z'
),
(
  ...
  'Partnerships', 'Working together', 3,
  '/img/presentation-img/IMG-20231019-WA0013.jpg', true, false, '2025-11-16T12:00:00Z'
),
(
  ...
  'Perspective', 'Designing for impact', 4,
  '/img/presentation-img/IMG-20231019-WA0016.jpg', true, false, '2025-11-23T12:00:00Z'
)
